...
class Rma(models.Model):
    ...
    #     comodel_name="stock.procurement.group",
    ...
    @api.depends(
        ...
        # NOTE: 'scrapped' field was removed from stock.move in Odoo 19
    ...
    def _compute_delivered_qty(self):
        ...
        for record in self:
            delivered_qty = 0.0
            # NOTE: 'scrapped' filter removed as field doesn't exist in Odoo 19
